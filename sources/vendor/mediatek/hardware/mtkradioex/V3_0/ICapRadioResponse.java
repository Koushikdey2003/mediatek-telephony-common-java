...
public interface ICapRadioResponse extends IBase {
    ...
    static ICapRadioResponse asInterface(IHwBinder binder) {
        ...
        ICapRadioResponse iCapRadioResponseQueryLocalInterface = binder.queryLocalInterface(kInterfaceName);
        if (iCapRadioResponseQueryLocalInterface != null && (iCapRadioResponseQueryLocalInterface instanceof ICapRadioResponse)) {
            return iCapRadioResponseQueryLocalInterface;
        }
    ...
    public static final class Proxy implements ICapRadioResponse {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V3_0.ICapRadioResponse
    ...
    public static abstract class Stub extends HwBinder implements ICapRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-53, 83, 4, -67, 51, 124, 15, 56, -78, 84, -74, 36, 81, 11, -18, 74, 77, 68, -114, -124, 63, 89, 116, 120, 43, 91, -3, -13, -67, 78, -96, -66}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    ArrayList<Byte> rnd = _hidl_request.readInt8Vector();
                    int custId = _hidl_request.readInt32();
                    routeCertificateResponse(info, rnd, custId);
                    return;
                case 2:
                    _hidl_request.enforceInterface(ICapRadioResponse.kInterfaceName);
                    RadioResponseInfo info2 = new RadioResponseInfo();
                    info2.readFromParcel(_hidl_request);
                    ArrayList<Byte> devId = _hidl_request.readInt8Vector();
                    int capMask = _hidl_request.readInt32();
                    routeAuthMessageResponse(info2, devId, capMask);
                    return;
                case 3:
                    _hidl_request.enforceInterface(ICapRadioResponse.kInterfaceName);
