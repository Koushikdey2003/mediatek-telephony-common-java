...
public interface IImsRadioResponse extends IBase {
    ...
    public static final class Proxy implements IImsRadioResponse {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V3_0.IImsRadioResponse
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-76, 9, -77, 40, 12, -83, 34, 35, 52, 22, 107, -14, -31, -84, 42, 78, 101, -11, -57, -117, -35, 2, -119, -70, -24, 113, -60, 18, -49, 78, -97, 40}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 35:
                    ...
                    queryCallForwardInTimeSlotStatusResponse(info35, callForwardInfoExs);
                    return;
                case 36:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                ...
                case 37:
                    ...
                    runGbaAuthenticationResponse(info37, resList);
                    return;
                case 38:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                    ...
                    setModemImsCfgResponse(info38, results);
                    return;
                case 39:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                ...
                case 44:
                    ...
                    getImsCfgFeatureValueResponse(info44, value);
                    return;
                case 45:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                ...
                case MtkCatService.MSG_ID_CACHED_DISPLAY_TEXT_TIMEOUT /* 46 */:
                    ...
                    getImsCfgProvisionValueResponse(info46, value2);
                    return;
                case MtkCatService.MSG_ID_CONN_RETRY_TIMEOUT /* 47 */:
                    ...
                    getImsCfgResourceCapValueResponse(info47, value3);
                    return;
                case 48:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                ...
                case 54:
                    ...
                    queryVopsStatusResponse(info54, vops);
                    return;
                case 55:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                    ...
                    getVoiceDomainPreferenceResponse(info55, vdp);
                    return;
                case 56:
                    _hidl_request.enforceInterface(IImsRadioResponse.kInterfaceName);
                ...
                case 60:
                    ...
                    querySsacStatusResponse(info60, status);
                    return;
