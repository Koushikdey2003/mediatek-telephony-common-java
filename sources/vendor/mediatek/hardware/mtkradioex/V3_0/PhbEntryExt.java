...
public final class PhbEntryExt {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.adnumber_a = _hidl_blob.getString(_hidl_offset + 88);
        parcel.readEmbeddedBuffer(r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 88 + 0, false);
        this.adnumber_b = _hidl_blob.getString(_hidl_offset + 104);
        parcel.readEmbeddedBuffer(r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 104 + 0, false);
        this.adtype = _hidl_blob.getInt32(_hidl_offset + 120);
        this.secondtext = _hidl_blob.getString(_hidl_offset + 128);
        parcel.readEmbeddedBuffer(r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 128 + 0, false);
        this.email = _hidl_blob.getString(_hidl_offset + 144);
        parcel.readEmbeddedBuffer(r6.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 144 + 0, false);
        this.secondtext_dcs = _hidl_blob.getInt32(_hidl_offset + 160);
        this.email_dcs = _hidl_blob.getInt32(_hidl_offset + 164);
        this.text_dcs = _hidl_blob.getInt32(_hidl_offset + 168);
    }
