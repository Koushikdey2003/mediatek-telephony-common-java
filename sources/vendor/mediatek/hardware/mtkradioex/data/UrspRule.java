...
public class UrspRule implements Parcelable {
    public static final Parcelable.Creator<UrspRule> CREATOR = new Parcelable.Creator<UrspRule>() { // from class: vendor.mediatek.hardware.mtkradioex.data.UrspRule.1
    ...
    public String toString() {
        ...
        return "vendor.mediatek.hardware.mtkradioex.data.UrspRule" + _aidl_sj.toString();
    }
