...
public class SetupDataCallResultSlice implements Parcelable {
    public static final Parcelable.Creator<SetupDataCallResultSlice> CREATOR = new Parcelable.Creator<SetupDataCallResultSlice>() { // from class: vendor.mediatek.hardware.mtkradioex.data.SetupDataCallResultSlice.1
        @Override // android.os.Parcelable.Creator
        public SetupDataCallResultSlice createFromParcel(Parcel _aidl_source) {
            SetupDataCallResultSlice _aidl_out = new SetupDataCallResultSlice();
            _aidl_out.readFromParcel(_aidl_source);
            return _aidl_out;
        }

        @Override // android.os.Parcelable.Creator
        public SetupDataCallResultSlice[] newArray(int _aidl_size) {
            return new SetupDataCallResultSlice[_aidl_size];
        }
    };
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.defaultQos = (android.hardware.radio.data.Qos) _aidl_parcel.readTypedObject(android.hardware.radio.data.Qos.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public String toString() {
        ...
        return "vendor.mediatek.hardware.mtkradioex.data.SetupDataCallResultSlice" + _aidl_sj.toString();
    }
