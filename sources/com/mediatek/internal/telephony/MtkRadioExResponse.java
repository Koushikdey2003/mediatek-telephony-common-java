...
public class MtkRadioExResponse extends MtkRadioExResponseBase {
    ...
    @Override // com.mediatek.internal.telephony.MtkRadioExResponseBase, vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioExResponse
        ...
        if (rr != null) {
            ...
            if (responseInfo.error == 0) {
                ...
                for (int i = 0; i < networkInfos.size(); i++) {
                    ...
                    if (!networkInfos.get(i).base.alphaLong.toUpperCase().endsWith(networkInfos.get(i).act)) {
                        networkInfos.get(i).base.alphaLong = networkInfos.get(i).base.alphaLong.concat(" " + networkInfos.get(i).act);
                    }
                    if (!networkInfos.get(i).base.alphaShort.toUpperCase().endsWith(networkInfos.get(i).act)) {
    ...
    public void sendRsuRequestResponse(RadioResponseInfo responseInfo, RsuResponseInfo rsuInfo) {
        this.mMtkRil.mtkRiljLog("default sendRsuRequestResponse");
        com.android.internal.telephony.RILRequest rr = this.mMtkRil.processResponse(responseInfo);
        if (rr != null) {
    ...
    public void getTOEInfoResponse(RadioResponseInfo responseInfo, String longName, String shortName, String numeric) {
        this.mMtkRil.getMtkRadioResponse().responseStrings(responseInfo, new String[]{longName, shortName, numeric});
    }
    ...
    public void getCALinkEnableStatusResponse(RadioResponseInfo radioResponseInfo, boolean z) {
        this.mMtkRil.getMtkRadioResponse().responseInts(radioResponseInfo, new int[]{z ? 1 : 0});
    }
    ...
    public void getCALinkCapabilityListResponse(RadioResponseInfo responseInfo, ArrayList<String> linkCapabilityList) {
        this.mMtkRil.getMtkRadioResponse();
        MtkRadioResponse.responseStringArrayList(this.mMtkRil, responseInfo, linkCapabilityList);
    }
    ...
    private void responseLteData(RadioResponseInfo responseInfo, LteData data) {
        ...
        if (rr != null) {
            ...
            if (responseInfo.error == 0) {
                ...
                this.mMtkRil.riljLog("responseLteData: from HIDL: " + regState);
                ret = data;
                this.mMtkRil.getMtkRadioResponse();
                MtkRadioResponse.sendMessageResponse(rr.mResult, ret);
            }
    ...
    public void getQamEnabledResponse(RadioResponseInfo radioResponseInfo, boolean z, boolean z2) {
        this.mMtkRil.getMtkRadioResponse().responseInts(radioResponseInfo, new int[]{z ? 1 : 0, z2 ? 1 : 0});
    }
    ...
    public void getLteScanDurationResponse(RadioResponseInfo info, int duration) {
        this.mMtkRil.getMtkRadioResponse().responseInts(info, new int[]{duration});
    }

    @Override // com.mediatek.internal.telephony.MtkRadioExResponseBase, vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioExResponse
    public void getLteRRCStateResponse(RadioResponseInfo responseInfo, int state) {
        this.mMtkRil.getMtkRadioResponse().responseInts(responseInfo, new int[]{state});
    }
    ...
    public void getBandPriorityListResponse(RadioResponseInfo responseInfo, ArrayList<Integer> bandPriList) {
        this.mMtkRil.getMtkRadioResponse().responseIntArrayList(responseInfo, bandPriList);
    }
    ...
    public void get4x4MimoEnabledResponse(RadioResponseInfo responseInfo, int enabled_bitmask) {
        this.mMtkRil.getMtkRadioResponse().responseInts(responseInfo, new int[]{enabled_bitmask});
    }
    ...
    public void getLteBsrTimerResponse(RadioResponseInfo responseInfo, int timer) {
        ...
        this.mMtkRil.getMtkRadioResponse().responseInts(responseInfo, new int[]{timer});
    }
    ...
    @Override // com.mediatek.internal.telephony.MtkRadioExResponseBase, vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioExResponse
    public void getLte1xRttCellListResponse(RadioResponseInfo responseInfo, ArrayList<Lte1xRttCellInfo> list) {
        this.mMtkRil.riljLog("getLte1xRttCellListResponse, list.size= " + list.size());
        com.android.internal.telephony.RILRequest rr = this.mMtkRil.processResponse(responseInfo);
        if (rr != null) {
            if (responseInfo.error == 0) {
                this.mMtkRil.getMtkRadioResponse();
    ...
    @Override // com.mediatek.internal.telephony.MtkRadioExResponseBase, vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioExResponse
    public void getEngineeringModeInfoResponse(RadioResponseInfo responseInfo, ArrayList<String> data) {
        this.mMtkRil.getMtkRadioResponse();
        MtkRadioResponse.responseStringArrayList(this.mMtkRil, responseInfo, data);
    }
