...
public class WorldMode extends Handler {
    ...
    private final BroadcastReceiver mWorldModeReceiver = new BroadcastReceiver() { // from class: com.mediatek.internal.telephony.worldphone.WorldMode.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (WorldMode.ACTION_WORLD_MODE_CHANGED.equals(action)) {
                ...
                if (wmState == 1) {
                    WorldMode.sCurrentWorldMode = WorldMode.updateCurrentWorldMode();
                }
    ...
    public WorldMode() {
        ...
        for (int i = 0; i < PROJECT_SIM_NUM; i++) {
            ...
            MtkRIL mtkRIL = (MtkRIL) smCi[i];
            mtkRILArr[i] = mtkRIL;
            mtkRIL.registerForOn(this, i + 1, null);
        }
        ...
        sContext.registerReceiver(this.mWorldModeReceiver, intentFilter, 2);
    }
