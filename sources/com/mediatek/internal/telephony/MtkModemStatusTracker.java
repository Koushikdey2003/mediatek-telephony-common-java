...
public class MtkModemStatusTracker {
        ...
        while (System.currentTimeMillis() < finish) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (mModemStatus[i] != mModemStatus[(mModemStatus.length - 4) + i]) {
                ...
                if (mIsReadSuccess) {
                    ByteBuffer mByteBuffer = ByteBuffer.wrap(mModemStatus);
                    long mModemTime = Long.reverseBytes(mByteBuffer.getLong(index));
                    return mModemTime;
                }
            } catch (IOException e) {
    ...
    public static long getModemSleepTime() {
        return readDataFromFile(SLP_SHM_MD_SLEEP_TIME);
    }
    ...
    /* JADX INFO: renamed from: com.mediatek.internal.telephony.MtkModemStatusTracker$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel;

        static {
            int[] iArr = new int[TxLevel.values().length];
            $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel = iArr;
            try {
                iArr[TxLevel.TX_LEVEL_BELOW_MINUS_FIVE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_MINUS_FIVE_TO_ONE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_ONE_TO_FIVE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_FIVE_TO_TEN.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_TEN_TO_FIFTEEN.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_FIFTEEN_TO_TWENTY.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_TWENTY_TO_TWENTY_THREE.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[TxLevel.TX_LEVEL_TWENTY_THREE_TO_TWENTY_SIX.ordinal()] = 8;
    ...
    public static long getModemTxLevelTime(Rat rat, TxLevel txLevel) {
        if (rat == Rat.RADIO_4G) {
            switch (AnonymousClass1.$SwitchMap$com$mediatek$internal$telephony$MtkModemStatusTracker$TxLevel[txLevel.ordinal()]) {
                case 1:
