...
/* JADX INFO: compiled from: MtkResponseData.java */
...
class MtkProvideLocalInformationResponseData extends ResponseData {
    ...
    public MtkProvideLocalInformationResponseData(int year, int month, int day, int hour, int minute, int second, int timezone) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.hour = hour;
